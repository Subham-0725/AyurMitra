...
const Navbar = () => {
  ...
  const loginOptions = ['Patient', 'Vaidya', 'Therapist'];
              ...
              <div className="group cursor-pointer" onClick={() => navigate('/')}>
                <div className="flex items-center space-x-3">
                  ...
                  <div className="hidden sm:block">
                    <h1 className="text-xl font-bold text-gray-800 tracking-tight">AyurMitra</h1>
                    <p className="text-xs text-gray-500 font-medium">Wellness Management</p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              {isAnyUserLoggedIn ? (
                ...
                <DropdownMenu open={isLoginOpen} onOpenChange={setIsLoginOpen}>
                  <DropdownMenuTrigger
                    className="bg-gradient-to-r from-emerald-600 to-teal-700 hover:from-emerald-700 hover:to-teal-800 text-white px-6 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 flex items-center space-x-2 shadow-lg hover:shadow-xl border border-emerald-500/20"
                  >
                    <span>Login</span>
          ...
          <div className="px-6 py-6 bg-white/98 backdrop-blur-xl border-t border-gray-100">
            ...
            <div className="mt-6 pt-4 border-t border-gray-100">
              {isAnyUserLoggedIn ? (
                ...
                <div className="space-y-2">
                  <div className="text-xs font-semibold text-gray-500 uppercase tracking-wide px-4 py-2">Login as:</div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[9999]">
          <div className="bg-white rounded-2xl p-8 max-w-md mx-4 shadow-2xl border border-gray-100">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">Are you sure you want to end your current session?</p>
            </div>
